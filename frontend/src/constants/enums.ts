...
const M = {
  ...
  CaseStatus: { PENDING_DISPATCH: '待派单', PROVIDER_SEA: '服务商公海', IN_PROGRESS: '催收中', PROMISED: '已承诺', SETTLED: '已结清', WITHDRAWN: '已撤回', BAD_DEBT: '坏账', VOIDED: '已作废' },
  ...
  ScriptSource: { AI_MINED: 'AI 挖掘', EXPERT: '专家' },
