...
- 候选修复提交：`a105d54`（成员）、`b11ade0`（批次减免权限）、`5229d0f`（扫描与验收加固）、`6f3a7f1`/`0a015a6`（bare checkout 验收兼容）、`18106cf`（GNU/POSIX chmod 兼容）、`ed96a3f`/`a4aca60`（契约环境与仓库隔离）、`2a9c988`/`b72f355`（登录 API 静默与 trace 关闭）
